...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ROLE_t, stringdata) + ofs \
...
const QMetaObject ROLE::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ROLE.data,
      qt_meta_data_ROLE,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ROLE.stringdata))
