...
#include "../../Qt Flappy Bird/floor.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FLOOR_t, stringdata) + ofs \
...
const QMetaObject FLOOR::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FLOOR.data,
      qt_meta_data_FLOOR,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FLOOR::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FLOOR.stringdata))
        return static_cast<void*>(const_cast< FLOOR*>(this));
